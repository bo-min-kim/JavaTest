...
function Datepicker() {
	...
	this._defaults = { // Global defaults for all the date picker instances
		...
		reverseYearRange: false, // Year Order Reverse
		yearNames: "" //Year after Name
	};
...
$.extend(Datepicker.prototype, {
	...
	_generateHTML: function(inst) {
		...
		var controls = (!inst.inline ? '<button type="button" class="ui-datepicker-close ui-state-default ui-priority-secondary " data-handler="hide" data-event="click">' +
	...
	_generateMonthYearHeader: function(inst, drawMonth, drawYear, minDate, maxDate,
		...
		if ( !inst.yearshtml ) {
			...
			if (secondary || !changeYear)
				...
				var yearNames = this._get(inst, 'yearNames');
				...
				if(reverseYearRange){
					for (; year <= endYear; endYear--) {
						inst.yearshtml += '<option value="' + endYear + '"' +
							...
							'>' + endYear + yearNames+ '</option>';
					}
				} else {
					for (; year <= endYear; year++) {
						inst.yearshtml += '<option value="' + year + '"' +
							(year == drawYear ? ' selected="selected"' : '') +
							'>' + year + yearNames + '</option>';
					}
				}
