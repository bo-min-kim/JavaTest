    ...
    <body id="page-top">
                    ...
                    <ul class="navbar-nav text-uppercase ml-auto">
                        ...
                        <li class="nav-item dropdown"><a class="nav-link dropdown-toggle" data-toggle="dropdown" href="#">온라인 상품<span class="caret"></span></a>
							<ul class="dropdown-menu menuList">
								...
								<li><c:if test="${whologin != 0}">
									<a class="nav-link" href="<%=NoForm%>mallCalculate">나의 쇼핑 내역</a>
								</c:if></li>
								<li><c:if test="${whologin != 0}">
                    	...
                    	<li class="nav-item dropdown"><a class="nav-link dropdown-toggle" data-toggle="dropdown" href="#">상담/예약<span class="caret"></span></a>
							<ul class="dropdown-menu menuList">
								...
								<li><c:if test="${whologin == 2}">
										<a class="nav-link" href="<%=NoForm%>adminReservation">온라인 예약 현황</a>
									</c:if>
								</li>								
								<li><a class="nav-link" href="<%=NoForm%>reservation">온라인 예약</a></li>
								<li><c:if test="${whologin == 2}">
										<a class="nav-link" href="<%=NoForm%>cuCustormerCheck">고객의 소리 현황</a>
									</c:if>
								</li>								
								<li><a class="nav-link" href="<%=NoForm%>cuCustormerInsert">고객의 소리</a></li>
							</ul>
						</li>
						<li><c:if test="${whologin == 2}">
							<li class="nav-item dropdown"><a class="nav-link dropdown-toggle" data-toggle="dropdown" href="#">데이터<span class="caret"></span></a>
								<ul class="dropdown-menu menuList">
									<li><a class="nav-link" href="<%=NoForm%>viewExam01">회원/게시물</a></li>
									<li><a class="nav-link" href="<%=NoForm%>viewExam02">회원별 게시물 건수</a></li>
									<li><a class="nav-link" href="<%=NoForm%>viewExam03">주문 정보</a></li>
									<li><a class="nav-link" href="<%=NoForm%>viewExam04">고객별 매출 총액</a></li>
									<li><a class="nav-link" href="<%=NoForm%>viewExam05">회원별 주문 건수</a></li>	
								</ul>
							</li>
						</c:if></li>
        ...
        <%-- <div class="quick">
            <ul>
                ...
                <li><a href="<%=NoForm%>boCounselList"><img src="${contextPath}/images/tooth01.jpg" alt="" title=""></a></li>
                <li><a href="<%=NoForm%>boJinryoIntro"><img src="${contextPath}/images/tooth04.jpg" alt="" title=""></a></li>                
                  <li><a href="<%=NoForm%>prList"><img src="${contextPath}/images/tooth03.jpg" alt=""></a></li>
                <li><a href="<%=NoForm%>boDirection"><img src="${contextPath}/images/tooth02.jpg" alt=""></a></li>               
            </ul>
