...
<body>
	...
	<div class="page_content_area ">
		...
		<div class="wpb_row vc_row-fluid has-half-column-txt-with-img"style="text-align:left;">
			<div class="container">
				<div class="row">
					<p><img class="img-fluid" src="${contextPath}/assets/img/portfolio/sub2-thum.jpg" alt="" width="400" height="327" /></p>
		
					<p class="pstyle">교정치료란 단순히 비뚤어진 치아를 가지런히 하는 것뿐만 아니라 성장과정에서<br />
