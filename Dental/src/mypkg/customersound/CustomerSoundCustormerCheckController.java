...
public class CustomerSoundCustormerCheckController extends SuperClass{
	...
	public void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		String myurl = contextPath + "/tooth?command=cuCustormerCheck";
		...
		List<CustomerSound> lists = dao.SelectDataList(
		...
		// 상세 보기, 수정, 삭제 등의 링크에 사용될 parameter list 문자열
		request.setAttribute("parameters", parameters.toString());
		
		super.doGet(request, response);		
		String gotopage = "customersound/cuCustormerCheck.jsp";
