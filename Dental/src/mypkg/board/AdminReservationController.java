...
public class AdminReservationController extends SuperClass{
	@Override
	public void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		String myurl = contextPath + "/tooth?command=adminReservation";
		...
		List<Reservation> lists = dao.SelectReservationList(
		...
		String gotopage = "board/adminReservationForm.jsp";
