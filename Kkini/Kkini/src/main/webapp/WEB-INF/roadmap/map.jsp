...
<h2 class="tit_snb">맛집로드</h2>
<div class="inner_snb">
<ul class="list_menu">
<li class="on">
<a href="/shop/board/list.php?id=notice">지도</a>
</li>
</ul>
</div>
</div>
...
<form name=fm id="fm" method=post action="/shop/mypage/indb.php" enctype="multipart/form-data" onSubmit="return chkForm(this)" style="height: 50%;">
...
<script type="text/javascript" src="//dapi.kakao.com/v2/maps/sdk.js?appkey=f837ebd3fa90c2c109868ed48b8e5ab4"></script>
