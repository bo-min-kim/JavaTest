...
var jwtToken = 'eyJ0eXAiOiJKV1QiLCJhbGciOiJIUzI1NiJ9..IZmgBlHPQ4556TVZYyRzgke3hQwfQT0YKTkTj5yGC5o';
...
<script>
  ...
  gtag('config', 'G-2K2GN0FFY0', {
    'user_id' : '5114d1c1-fefa-4014-bed6-107b4afb925e'
  });
</script>
...
if(amplitudeUid === null){
	amplitudeUid = '5114d1c1-fefa-4014-bed6-107b4afb925e';
}
var appResult = {
  ...
  isSession: false,
	appCheck: false,
	device: 'pc',
  timestamp: parseInt("1614666671398", 10)
}
...
var getGoodsRecent = (function(){
    var i, len, getGoodsRecent, item, _nowTime = '1614666671414';
...
<h2 class="tit">광고 문의<span class="tit_sub">kkini의 광고 문의를 자유롭게 적어주세요!</span></h2>
</div>
...
<a href="view.php?id=notice&no=834"><b>[광고 문의] 서울 "ooo 냉면" 새로 오픈했습니다. 오픈이벤트 있습니다</a>
</td>
<td width=100 nowrap align=center>
toza97 </td>
<td width=100 nowrap align=center class=eng2>2021-03-02</td>
<td width=30 nowrap align=center class=eng2>51</td>
</tr>
<tr>
<td width=50 nowrap align=center>
광고 </td>
...
<td>
<div class="search_bt">
<a href="javascript:document.frmList.submit()"><img src="https://www.kurly.com/shop/data/skin/designgj/images/board/search.png" align=absmiddle></a>
...
<a href="../common/community/advertiseInsertForm.jsp">글쓰기</span></a>
</div>
</div>
